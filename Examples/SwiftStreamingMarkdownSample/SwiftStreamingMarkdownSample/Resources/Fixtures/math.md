# Pythagorean theorem
Relates the sides of a right triangle and is foundational in geometry, trigonometry, and distance calculations. In compact form it is written inline as \(a^2 + b^2 = c^2\).
$$a^2 + b^2 = c^2$$
...
# Newton's second law
Connects net force to mass and acceleration, forming a core equation in classical mechanics. It is often quoted inline as \(F = ma\).
$$F = ma$$

# Mass-energy equivalence
States that mass can be interpreted as a concentrated form of energy. Einstein's famous inline form is \(E = mc^2\).
$$E = mc^2$$
